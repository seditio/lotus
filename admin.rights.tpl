...
<!-- END: RIGHTS_ROW_ITEMS -->
					<td class="centerall">
						<a class="btn btn-danger btn-small" title="{PHP.L.Rights}" href="{ADMIN_RIGHTS_ROW_RIGHTSBYITEM}"><i class="icon-lock"></i> {PHP.L.Rights}</a>
						<a class="btn btn-primary btn-small" title="{PHP.L.Rights}" href="{ADMIN_RIGHTS_ROW_LINK}"><i class="icon-folder-open"></i> {PHP.L.Open}</a>
					</td>
...
<!-- END: RIGHTS_SECTION -->
			<div class="text-center">
				<a class="btn btn-primary" href="{ADMIN_RIGHTS_ADVANCED_URL}">{PHP.L.More}</a>
